...
public class PicturesActivity extends Activity {
  ...
  private com.ncsoft.gameadmin.mobilegameadmin.PicturesApp getApp() {
    return (com.ncsoft.gameadmin.mobilegameadmin.PicturesApp) getApplication();
  }
  ...
  public static class PictureListLoader {
    ...
    public void load(final com.ncsoft.gameadmin.mobilegameadmin.PicturesApp app) {
      ...
      requestQueue.add(new StringRequest(com.ncsoft.gameadmin.mobilegameadmin.PicturesApp.PICTURE_SERVER, listener, errorListener));
    }
  }
  ...
  public class PictureListAdapter extends BaseAdapter {
    ...
    @Override public View getView(int position, View convertView, ViewGroup parent) {
      ...
      com.ncsoft.gameadmin.mobilegameadmin.PicturesApp app = getApp();
